...
* [Characters]('./src/Character/Characters.jsx) is a demo using Redux to do fetch to get characters from the star wars universe from [the star wars api](https://swapi.co/)
